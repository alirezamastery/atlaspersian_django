"""
Django settings for atlaspersian project.
...
ROOT_URLCONF = 'atlaspersian.urls'
...
WSGI_APPLICATION = 'atlaspersian.wsgi.application'
...
SMS_TEMPLATE_ID = config('SMS_TEMPLATE_ID', cast=int)
